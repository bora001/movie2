...
function LandingPage(props) {
  ...
  useEffect(() => {
    ...
    //get api
    axios.post("/api/movieapi").then((response) => {
        ...
        <div className="latest_movie">
          {MainMovieImage && (
            <MainImage
              ...
              rate={MainMovieImage.vote_average}
              release={MainMovieImage.release_date}
          ...
          <button className="btn_load" onClick={onloadHandler}>
            Load More
          </button>
        </div>
      </div>
